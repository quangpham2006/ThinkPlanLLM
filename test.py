...
model_hugging = AutoModelForCausalLM.from_pretrained(model_name_LLM_hugging).to("cuda")
...
def create_env(cfg, agent: str, config_file: str, scene_id: str, control_freq: float, cheap: bool, seed: int) -> LLMEnv:
    ...
    llm = LLM_hugging(debug=True, model=model_hugging, tokenizer=tokenizer_hugging, room_classification_model="gpt-3.5-turbo-1106", open_set_rooms=cfg["open_set_room_categories"],)
